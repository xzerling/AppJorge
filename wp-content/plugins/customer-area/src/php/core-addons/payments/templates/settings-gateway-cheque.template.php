...
<tr valign="top">
    <td>
        ...
        <?php $settings->print_input_field(array(
            'option_id' => $gateway->get_option_id(CUAR_ChequePaymentGateway::$OPTION_SUCCESS_MESSAGE),
            'type'      => 'editor',
        )); ?>
    </td>
</tr>
<tr valign="top">
    <td>
        ...
        <?php $settings->print_input_field(array(
            'option_id' => $gateway->get_option_id(CUAR_ChequePaymentGateway::$OPTION_CHECKOUT_MESSAGE),
            'type'      => 'editor',
        )); ?>
    </td>
</tr>
